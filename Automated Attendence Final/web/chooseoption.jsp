...
<html>
    ...
    <%  String[] course_list, dept_list;
        ...
        String jsp = request.getParameter("jsp"), course = request.getParameter("course_id"), date = request.getParameter("date");
        String[] semester;
        if (year_id == null) {
            year_id = year + "";
    ...
    <body class="skin-blue">
        <div class="wrapper">
            <input id="jsp" value="<%=jsp%>" style="visibility: false;display:none;">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <center>
                        <%if (jsp.equals("newclass")) {%>
                        <h3><b>Provide Information Before Adding New Class :</b></h3>
                        <%} else {%>
                        <h3><b>Provide Information Before Publishing Result :</b></h3>
                        <%}%>
                    </center>
                    <center>
                        <div class="box box-warning">
                            <div class="login-box-body">
                                <form action="chooseoption.jsp" id="info">
                                    ...
                                    <select class="form-control" style="width:100px;" name="year_id" onchange="JavaScript:reload()">
                                        <%
                                            for (int i = Integer.parseInt(year_id) - 5; i <= Integer.parseInt(year_id) + 5; ++i) {
                                                if (i == Integer.parseInt(year_id)) {
                                        %>
                                    ...
                                    <input name="jsp" value="<%=jsp%>" style="display:none;"><br>
                                    <%if (course_list[0] != null) {%>
                                    <button class="btn btn-info btn-flat" id="GO" onclick="JavaScript:next()" > Go </button>
                                    <%} else {%>
        ...
        <script>
                                        ...
                                        function next() {
                                            document.getElementById("info").action = document.getElementById("jsp").value + ".jsp";
                                            document.getElementById("info").submit();
                                        }
