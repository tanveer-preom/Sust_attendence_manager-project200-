            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <div class="row content">
                        ...
                        <%
                            int i, j;
                            for (i = 0; i <= course_list.length && course_list[i] != null; ++i) {%>
                        <section class="col-md-4 connectedSortable">

                            <%for (j = i; j <= i + 7 && j <= course_list.length && course_list[j] != null; ++j) {%> <div>
                                <a  class="btn btn-info btn-flat" style="width: 150px;" href="attendencetable.jsp?dept=<%=dept%>&semester_id=<%=semester_id%>&year_id=<%=year_id%>&course_id=<%=course_list[j]%>&day=1&month=0"><%= course_list[j]%></a> </div>
                            <br><%}
                                    i = j;%>
                        </section>
                        <%}%>
