            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a href="chooseoption.jsp?jsp=publishpdf&year_id=<%=year_id%>&dept=<%=dept%>">
                                <i class="fa fa-th"></i> <span>Publish Result</span> 
                            </a>
                        </li>
                        <li class="treeview">
                            <a href="chooseoption.jsp?jsp=newclass&dept=<%=dept%>">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <div class="row content">
                        <h3><b>Select Semester ID of <%=dept%> department:</b></h3><br>
                        <section class="col-md-4 connectedSortable">
                            <form action="courses.jsp">
                                <select class="btn btn-info btn-flat" style="background-color:white;color:black;" name="year_id" >
                                    <% for (int i = year_id - 10; i < year_id + 10; ++i) {
                                            if (year_id == i) {%>
                                    <option value="<%=i%>" id="input" selected> <%=i%> </option> <%} else {%>
                                    <option value="<%=i%>" id="input"> <%=i%> </option> 
                                    <%}
                                        }%>
                                </select> 
                                <select   class="btn btn-info btn-flat" style="background-color:white;color:black;" name="semester_id" >
                                    <% for (int i = 0; semester[i] != null; ++i) {
                                            if (year_id == i) {%>
                                ...
                                <input type="submit" value="next" class="btn btn-info btn-flat">
